...
date: 2021-05-11T20:26:00+08:00
draft: false
tags: ["go", "k8s", "docker"]
categories: ["运维"]
---
...
说明：无高可用，etcd亦单机版，单主两节点

系统：CentOS 7.2（阿里云ECS，无安全组、iptables、selinux，时间同步，2C 4G）
...
增加内核参数（将桥接的IPv4流量传递到iptables的链）
...
```bash
cd /usr/local/src
// https://storage.googleapis.com/kubernetes-release/release/v1.18.3/kubernetes-server-linux-amd64.tar.gz
...
node/k8s-node7   Ready    <none>   44m   v1.18.3   172.17.89.17   <none>        CentOS Linux 7 (Core)   3.10.0-514.6.2.el7.x86_64   containerd://1.4.4

$ kubectl get pod -n kube-system -o wide
NAME                    READY   STATUS    RESTARTS   AGE   IP             NODE        NOMINATED NODE   READINESS GATES
kube-flannel-ds-7cssx   1/1     Running   0          41m   172.17.89.17   k8s-node7   <none>           <none>
```
